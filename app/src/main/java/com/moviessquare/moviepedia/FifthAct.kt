...
import com.moviessquare.moviepedia.Adapter.TVAdapter
import com.moviessquare.moviepedia.Adapter.VideoAdapter
import com.moviessquare.moviepedia.Api.API
import com.moviessquare.moviepedia.DataClass.Rate
...
class FifthAct : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnWatchlistTV.setOnClickListener {
            ...
            if(chkW == 0) {
                val watchL = com.moviessquare.moviepedia.DataClass.watchlist(
                    "tv",
                    tv_id.toInt(),
                    true
                )
